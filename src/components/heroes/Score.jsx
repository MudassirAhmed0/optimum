...
w-[249.18px] h-[220.22px] object-contain  block md:hidden' />
            <img src={mobrightcoin} alt="Coin Rightmob" className='absolute right-[-23.18px] bottom-[-200px] w-[230.99px] h-[300px] object-contain  block md:hidden' />
                   ...
                   <li className='flex items-center gap-x-[79.51px] md:gap-x-[6.25vw] justify-center'><span className='md:leading-[2.109375vw] text-[#FF005C] text-[22.43px] leading-[26.92px] md:text-[1.752328125vw]'>Q1</span> <span className='text-[41.25px] leading-[49.5px] md:text-[3.22265625vw] text-[#fff] md:leading-[3.90625vw]'>2.51%</span></li> 
                   <li className='flex items-center gap-x-[79.51px] md:gap-x-[6.25vw] justify-center'><span className='md:leading-[2.109375vw] text-[#FF005C] text-[22.43px] leading-[26.92px] md:text-[1.752328125vw]'>Q1</span> <span className='text-[41.25px] leading-[49.5px] md:text-[3.22265625vw] text-[#fff] md:leading-[3.90625vw]'>1.91%</span></li> 
                   <li className='flex items-center gap-x-[79.51px] md:gap-x-[6.25vw] justify-center'><span className='md:leading-[2.109375vw] text-[#FF005C] text-[22.43px] leading-[26.92px] md:text-[1.752328125vw]'>Q1</span> <span className='text-[41.25px] leading-[49.5px] md:text-[3.22265625vw] text-[#fff] md:leading-[3.90625vw]'>1.93%</span></li> 
                </ul>
        </div>
    </div>
</div>
