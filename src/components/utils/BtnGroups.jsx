...
const BtnGroups = ({classes,white}) => {
  return (
    ...
    <div className='flex items-center  gap-x-[20px] md:gap-x-[1.5625vw] '>
        <span className='md:w-[1.89375vw] md:h-[1.25vw] w-[24.24px] h-[16px] bg-[#FF005C] clipPath2 '></span>
        <span className={`font-[700] text-[18px] md:text-[1.40625vw] leading-[27px] md:leading-[2.109375vw] ${white &&" text-white"}`}>Desposit</span>
    </div>
    <div className='flex items-center gap-x-[12px]  md:gap-x-[0.9375vw] '>
        ...
        <span className={`font-[700] text-[18px] md:text-[1.40625vw] leading-[27px] md:leading-[2.109375vw] ${white &&" text-white"}`}>Withdraw</span>
    </div>
</div>
  )
}
