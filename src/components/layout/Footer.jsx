...
const Footer = () => {
  return (
    <footer className=' absolute bottom-0 left-0 z-[55] w-full h-[97px] md:h-[4.0625vw]  flex md:items-center border-t  border-[#2B3D3E]'>
       ...
       <li>
        <Link to='/privacy-policy' className='text-[#718787] md:text-[1.09375vw] md:leading-[1.640625vw] text-[14px] leading-[21px]   md:tracking-[0.07109375vw]'>
        Privacy Policy
        </Link>
        </li>
       <li>
        <Link to='/terms-condition' className='text-[#718787] md:text-[1.09375vw] md:leading-[1.640625vw] text-[14px] leading-[21px]   md:tracking-[0.07109375vw]'>
        Terms and Conditions
        </Link>
        </li>
       <li className='w-full md:w-auto text-center' >
        <Link className='text-[#718787]  font-[700] md:text-[1.09375vw] md:leading-[1.640625vw] text-[14px] leading-[21px]   md:tracking-[0.07109375vw]'>
        Certik Audit
        </Link>
        </li>
        </ul>
